...
try:
    ...
    def config(key, default=None, cast=str):
        ...
        return cast(value) if value is not None and cast != str else value

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = config('SECRET_KEY', default="django-insecure-llp1=ck0#gvd%9ry7(cvcq$r*(1dik1*6$fswoqw+yw0l&#@tc")
...
DATABASES = {
    "default": {
        ...
        "NAME": config('DB_NAME', default='globetrotter'),
